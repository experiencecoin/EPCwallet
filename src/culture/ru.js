(function (translator) {
	translator.translations["ru"] = {
		...
		"paperlabelbitcoinaddress": "Адрес Experiencecoin кошелька:",
		...
		"singletip4": "<b>Проверить баланс кошелька</b> можно на сайте explorer.epcnodes.com по адресу Биткоин кошелька.",
		...
		"detaillabelnote2": "Приложение Experiencecoin версии 0.6 и выше хранит ключи в сжатом формате. Это приложение также поддерживает импорт и экспорт приватных ключей командами importprivkey/dumpprivkey. Формат экспортированного ключа определяется кошельком, который сгенерировал адрес Биткоин.",
